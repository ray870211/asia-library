...
export class AppComponent implements AfterViewInit {
    @ViewChild('theRadialGauge', { static: true }) theRadialGauge: gauge.RadialGauge;
    @ViewChild('theLinearGauge', { static: true }) theLinearGauge: gauge.LinearGauge;
    @ViewChild('theVerticalGauge', { static: true }) theVerticalGauge: gauge.LinearGauge;
    stackRanges = true;
    //
    ngAfterViewInit() {
        window.setInterval(() => {
