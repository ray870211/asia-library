        ...
        <div>
            <label>
                ...
                <input
                    ...
                    type="checkbox"
                    checked="true"
                    v-on:click="onCustomCSSClick($event)"
                />
            </label>
...
new Vue({
    ...
    methods: {
        ...
        onCustomCSSClick(e) {
            wjCore.toggleClass(
                this.wjTreeViewControl.hostElement,
                "accordion",
                e.target.checked
            );
        }
    ...
    mounted: function(e) {
        var self = this;
        this.wjTreeViewControl.hostElement.addEventListener("click", function(
            e
        ) {
            if (e.target.tagName == "A") {
                self.msg = wjCore.format(
                    "Navigating to <b>** {href} **</b>",
                    e.target
                );
                e.preventDefault();
            }
