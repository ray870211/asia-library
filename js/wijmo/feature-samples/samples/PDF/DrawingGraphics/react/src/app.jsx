...
class App extends React.Component {
    constructor() {
        super(...arguments);
        this.c1 = new wijmo.Color('#3173c0');
        this.c2 = new wijmo.Color('#e69500');
        this.a = 100; // sample area's size.
    }
    render() {
    ...
    $_sample1(doc) {
        ...
        //
        let y = doc.y + doc.lineHeight(), a = this.a, c1 = this.c1;
        //
    ...
    $_sample2(doc) {
        ...
        //
        let y = doc.y + doc.lineHeight(), a = this.a, c1 = this.c1, c2 = this.c2;
        //
        doc.paths
            .rect(0, y, a, a)
            .stroke(c1);
    ...
    $_sample4(doc) {
        ...
        //
        let y = doc.y + doc.lineHeight(), a = this.a, c1 = this.c1, c2 = this.c2, a0 = 10;
        //
        doc.saveState();
        //
        // clipping path
    ...
    $_sample5(doc) {
        ...
        //
        let y = doc.y + doc.lineHeight(), sqrt2 = Math.sqrt(2), degrees = 15, samples = 90 / degrees, a = this.a, c1 = this.c1, c2 = this.c2;
        //
        doc.saveState();
        //
